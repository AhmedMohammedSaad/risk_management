...
class Alghsarah7 extends StatefulWidget {
  const Alghsarah7({super.key, required this.nameBar, required this.nameCanun});
  final String nameBar;
  final String nameCanun;

  @override
  State<Alghsarah7> createState() => _Alghsarah7State();
}

class _Alghsarah7State extends State<Alghsarah7> {
