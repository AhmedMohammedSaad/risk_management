...
class Alghsarah6 extends StatefulWidget {
  const Alghsarah6({super.key, required this.nameBar, required this.nameCanun});
  final String nameBar;
  final String nameCanun;

  @override
  State<Alghsarah6> createState() => _Alghsarah6State();
}

class _Alghsarah6State extends State<Alghsarah6> {
