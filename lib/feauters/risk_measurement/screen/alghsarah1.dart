...
class Alghsarah1 extends StatefulWidget {
  const Alghsarah1({super.key, required this.nameBar, required this.nameCanun});
  final String nameBar;
  final String nameCanun;

  @override
  State<Alghsarah1> createState() => _Alghsarah1State();
}

class _Alghsarah1State extends State<Alghsarah1> {
